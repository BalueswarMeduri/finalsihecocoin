  ...
  return (
    <div className="mainContainer">
      <div className="whatis">
        <h1>What is carbon footprint calculation?</h1>
        <p>The total amount of greenhouse gases (including carbon dioxide and methane) that are generated by our actions.</p>
      </div>
      <div style={{ padding: "20px", maxWidth: "1000px", margin: "0 auto" }}>
        <h1 style={{ textAlign: "center" , margin:"1.3rem 0", fontWeight:"600", color:"var(--green)"}}>Carbon Footprint Calculator</h1>
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          <input
            ...
            style={{ margin: "10px 0", padding: "19px", width: "100%" }}
          />
